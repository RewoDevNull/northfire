...
final class MemberRegistered extends AggregateChanged
{
     ...
     *
     * @return \Northfire\Domain\Model\Member\Event\MemberRegistered
     */
    public static function withData(MemberId $memberId, string $memberNumber, string $firstName, string $lastName, VehicleId $vehicleId, \DateTime $joiningDate) : self
    {
        $event = self::occur(
            $memberId->toString(),
            [
